...
python train.py \
    $SUMM_DIR:$DAE_DIR \
    --user-dir mass --task translation_mix_kl --arch transformer_mix_base \
    ...
    --divide-decoder-encoder-attn-norm True \
    --divide-decoder-self-attn-query True \
    --save-dir $SAVE_DIR
